...
public partial class AdminPage : System.Web.UI.Page
{
    ...
    protected void LinkButton1_Click(object sender, EventArgs e) => Response.Redirect("AdminReg.aspx");
    ...
    protected void login_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand sqlCommand = new SqlCommand("Select * from UNIADMIN where EmplNo= @employee and Pswd = @password ", sqlConnection);
