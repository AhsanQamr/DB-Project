...
public partial class FypLogin : System.Web.UI.Page
{
    ...
    protected void login_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand sqlCommand = new SqlCommand("Select * from FYPDEPT where EmplNo= @employee and Pswd = @password ", sqlConnection);
        ...
        if (dataTable.Rows.Count > 0)
        {
            ...
            Response.Redirect("FypView.aspx");
